...
Route::post('/checkout/pay', [EventController::class, 'checkoutPay'])->name('checkoutPay');
Route::get('/checkout-success', [EventController::class, 'checkoutSuccess'])->name('checkout-succes');
