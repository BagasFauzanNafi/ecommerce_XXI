      ...
      <div class="overflow-hidden shadow sm:rounded-md">
        <div class="px-4 py-5 bg-white sm:p-6">
          <form method="POST"
            ...
            <div class="mb-6">
              <label for="headline" class="block mb-2 text-sm">Posisi Duduk</label>
            ...
            <div class="mb-6">
              <label for="description" class="block mb-2 text-sm">Judul Film</label>
            ...
            <div class="mb-6">
              <label for="start_time" class="block mb-2 text-sm">Tanggal Nonton</label>
            ...
            <div class="mb-6">
              <label for="duration" class="block mb-2 text-sm">Durasi Film (jam)</label>
            ...
            {{-- Categories --}}
            <div class="mb-6">
              <label for="category_id" class="block mb-2 text-sm">Genre</label>
            ...
            {{-- Type (online/offline) --}}
            <div class="mb-6">
              <label for="type" class="block mb-2 text-sm">Mode Pembayaran</label>
